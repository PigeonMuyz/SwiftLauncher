...
SOURCES=(
  ...
  "$ROOT_DIR/SwiftLauncher/Support/ModrinthInstalledModsIndex.swift"
  "$ROOT_DIR/SwiftLauncher/Support/MavenCoordinate.swift"
  "$ROOT_DIR/SwiftLauncher/Support/LoaderVersionResolver.swift"
  "$ROOT_DIR/SwiftLauncher/Services/JavaRuntimeService.swift"
  "$ROOT_DIR/SwiftLauncher/Services/LauncherFileSystem.swift"
  "$ROOT_DIR/SwiftLauncher/Services/RuleEvaluator.swift"
  "$ROOT_DIR/SwiftLauncher/Services/MojangMetadataService.swift"
  "$ROOT_DIR/SwiftLauncher/Services/DownloadEndpointResolver.swift"
  ...
  "$ROOT_DIR/SwiftLauncher/Services/ModrinthService.swift"
  "$ROOT_DIR/SwiftLauncher/Services/InstanceImportService.swift"
